...
OpenLayers.Map = OpenLayers.Class({
  ...
  // Options
     ...
     * {<OpenLayers.Bounds>} Save the current extent of the map, use for resize map at the good extent
     */
    currentExtent:null,
    
     /**
     * Property: mfA4jSupportId
     * {String} Unique identifier for the mapafaces ajax component to call for refreh layers
     */
    mfA4jSupportId: null,
    
    /**
     * Property: mfA4jPollId
     * {String} Unique identifier for the mapafaces ajax component to call for refresh the a4j:support component
     */
    mfA4jPollId: null,
    ...
    initialize: function (div, options) {
       ...
       //this.id = OpenLayers.Util.createUniqueID("OpenLayers.Map_");
        ...
        sc.innerHTML="function zoom(){"+
                          "if(window.maps)for(var map in window.maps){window.maps[map].zoomToMaxExtent();}"+
                     "};"+      
                     "window.onload=zoom;";
    ...
    sendAjaxRequest: function() {
       ...
       // if(this.getCurrentExtent() == null || bbox != this.getCurrentExtent().toBBOX()){
          var parameters = {    'synchronized': 'true',
                                'refresh': this.layersName + ','+this.mfA4jPollId,
                                'bbox': bbox,
          ...
          parameters[this.mfA4jSupportId] = this.mfA4jSupportId;
    ...
    updateSize: function() {
        ...
        if (!newSize.equals(oldSize)) {
            ...
            if (this != null) {
                ...
                this.zoom = null;
                //Add the if  to change the map size and zoom to the good extent
