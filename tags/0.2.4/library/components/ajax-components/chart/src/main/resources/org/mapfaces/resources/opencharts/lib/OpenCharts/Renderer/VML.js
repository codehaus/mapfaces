 ...
 * VML renderer with the <OpenCharts.Renderer.VML> constructor.
 * 
 ...
 */
OpenCharts.Renderer.VML = OpenCharts.Class(OpenCharts.Renderer.Elements, {
     ...
     * Finally, OpenCharts methods are used to determine the correct
    ...
    graphicRotate: function(node, xOffset, yOffset) {
        ...
        if (!(style.graphicWidth && style.graphicHeight)) {
            ...
            var img = new Image();
            img.onreadystatechange = OpenCharts.Function.bind(function() {
    ...
    setNodeDimension: function(node, geometry) {
        ...
        if(bbox) {
            ...
            var scaledBox = 
                new OpenCharts.Bounds((bbox.left/resolution - this.offset.x).toFixed(),
    ...
    drawRectangle: function(node, geometry) {
        var resolution = this.getResolution();
        //DEBUG IE
        //alert(geometry.x+" "+geometry.y+" "+geometry.width+" "+geometry.height+" "+resolution+" "+this.offset.x+" "+this.offset.y);
    ...
    CLASS_NAME: "OpenCharts.Renderer.VML"
});
