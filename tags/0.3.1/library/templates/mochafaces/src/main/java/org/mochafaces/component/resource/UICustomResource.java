 ...
 * @author kevindelfour
 */
public class UICustomResource extends UIBase {

    private static final String FAMILY = "org.mochafaces.CustomResourceLoader";
    ...
    public void restoreState(final FacesContext context, final Object state) {
        ...
        setSrc((String) values[1]);
        setMedia((String) values[2]);
    }
