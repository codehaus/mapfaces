...
/**
 * Class: OpenCharts.Renderer.Canvas 
 * A renderer based on the 2D 'canvas' drawing element.element
 * 
 * Inherits:
 *  - <OpenCharts.Renderer>
 */
OpenCharts.Renderer.Canvas = OpenCharts.Class(OpenCharts.Renderer, {
    ...
    /**
     * Constructor: OpenCharts.Renderer.Canvas
     *
     * Parameters:
     * containerID - {<String>} 
     */
     ...
     *
     * Parameters:
     * feature - {<OpenCharts.Feature.Vector>} 
     * style - {<Object>} 
     */
    ...
    drawExternalGraphic: function(pt, style) {
       ...
       img.onload = OpenCharts.Function.bind( function() {
    ...
    getFeatureIdFromEvent: function(evt) {
        ...
        var resolution = this.getResolution();
        var bounds = new OpenCharts.Bounds(loc.lon - resolution * 5, 
     ...
     * 
     * Parameters:
     * features - {Array(<OpenCharts.Feature.Vector>)} 
     */
    ...
    CLASS_NAME: "OpenCharts.Renderer.Canvas"
});
