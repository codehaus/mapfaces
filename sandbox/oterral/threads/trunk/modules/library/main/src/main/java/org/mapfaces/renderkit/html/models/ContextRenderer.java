   ...
   // private final String OPENLAYERS_JS = "/org/mapfaces/resources/openlayers/minify/OpenLayers.js";
    ...
    public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
        ...
        try {
            ...
            if (FacesUtils.findComponentById(context, component, comp.getId() + "_Ajax") == null) {
               ...
               // ajaxComp.setImmediate(true);
                ...
                ajaxComp.setTimeout(10000);
                ajaxComp.setIgnoreDupResponses(true);
                //ajaxComp.setReRender("j_id_jsp_1409544346_4_Poll");
                comp.getChildren().add(ajaxComp);
                comp.setAjaxCompId(comp.getClientId(context) + "_Ajax");
            }
        }catch(IOException e){
                    throw new IOException("The GetCapabilities file can't be parsed, probably a server is down : "+ e.getMessage()); 
