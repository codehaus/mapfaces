    ...
    */
    startBox: function (xy) {
        if (this.map.isHTML) {
            ...
            this.zoomBox = OpenLayers.Util.createRect('zoomBox',
                this.dragHandler.start);  
            this.map.div.setAttribute("style", "cursor:crosshair;")
    ...
    */
    moveBox: function (xy) {
        ...
        if (this.map.isHTML) {
            ...
            this.zoomBox.setAttribute("width",  Math.max(1, deltaX) );
            this.zoomBox.setAttribute("height", Math.max(1, deltaY));
            this.zoomBox.setAttribute("x", ((xy.x < startX) ? xy.x : startX) );
            this.zoomBox.setAttribute("y", ((xy.y < startY) ? xy.y : startY) );
            this.zoomBox.setAttribute("stroke", "blue");
            this.zoomBox.setAttribute("stroke", "3");
            this.zoomBox.setAttribute("fill", "yellow");
            this.zoomBox.setAttribute("fill-opacity", "0.2");
    ...
    */
    ...
    removeBox: function() {
        if (this.map.isHTML) {
            ...
            this.map.div.removeChild(this.zoomBox);
        }
        this.zoomBox = null;
