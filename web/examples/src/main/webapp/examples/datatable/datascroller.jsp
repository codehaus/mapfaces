...
<f:view>
    <html>
        ...
        <body>
            <h1><h:outputText value="MapFaces Datatable with dataScroller and sorting (client side only) by Mootools demo"/></h1>
            <h:form id="mainform">
                <h:panelGroup layout="block" style="width:600px;margin-left:60pt;">
                    <mfb:Datatable id="mfdatatable"
                        ...
                        <mfb:DataTableColumn axis="string">
                            ...
                            <h:outputText id="out" value="#{_row.value}" style="text-align:center;"/>
                            <f:facet name="footer"><h:outputText value=""/></f:facet>
                        </mfb:DataTableColumn>
                        ...
                        <mfb:DataTableColumn axis="string">
                            ...
                            <a4j:region selfRendered="true">
                                <a4j:commandLink value="change the name" reRender="out">
                                    <a4j:actionparam name="newName" value="Modified" assignTo="#{_row.value}"/>
                                </a4j:commandLink>
                            </a4j:region>
                            <f:facet name="footer"><h:outputText value=""/></f:facet>
                        </mfb:DataTableColumn>
                ...
                <h:panelGroup layout="block" style="width:400px;margin-left:60pt;">
                    <h:dataTable id="jsfdatatable"
                        ...
                        <h:column>
                            <f:facet name="header"><h:outputText value="action"/></f:facet>
                            <a4j:region selfRendered="true">
                                <a4j:commandLink value="change the name" reRender="out2">
                                    <a4j:actionparam name="newName" value="Success !!!" assignTo="#{_row2.value}"/>
                                </a4j:commandLink>
                            </a4j:region>
                            <f:facet name="footer"><h:outputText value=""/></f:facet>
                        </h:column>
                        ...
                        <h:column>
                            ...
                            <h:outputText id="out2" value="#{_row2.value}" style="text-align:center;"/>
