...
var TimePicker = new Class({
	...
	initialize: function(holder, field, toggler, options){
		...
		if (this.holder != null) this.holder.setStyles({'width':this.options.clockSize.width, 'height':this.options.clockSize.height});
		...
		if (this.holder != null) this.holder.adopt(img);
		...
		if (!this.options.visible){
			...
			if ((window.ie) && (!window.ie7)){
				...
				if(this.holder != null) this.holder.adopt(iframe);					

			}



			if(this.holder != null) this.holder.setStyles({
			...
			if ($defined(this.toggler)){
				...
				this.toggler.addEvent("click", function(e){
					...
					if (this.holder != null && this.holder.getStyle('opacity') == 0) this.openTimePicker();
			...
			if(this.holder != null) this.holder.adopt(cls);
		...
		if (this.holder != null) this.holder.adopt(this.minuteHand);
		...
		if (this.holder != null) this.holder.adopt(this.hourHand);
		...
		if (this.holder != null) this.holder.adopt(c_img);
		...
		if(this.holder != null) this.holder.adopt(this.ampm);
		...
		if (this.holder != null) this.holder.addEvent("mousedown", function(e){
		...
		if(this.holder != null) this.holder.addEvent("mouseup", function(){
		...
		if(this.holder != null) this.holder.addEvent("mousemove", function(e){
	...
	openTimePicker: function(){
		...
		if ($defined(this.field)){		
			...
			var coord;
			if(this.holder != null)
				coord = this.holder.getCoordinates();
	...
	closeTimePicker: function(){
		...
		if(this.holder != null) this.holder.setStyle('opacity', 0);			
