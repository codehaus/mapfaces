...
public class UICheckColumn extends UIColumnBase {
    ...
    private static final String RENDERER_TYPE = "org.mapfaces.renderkit.treebuilder.HTMLCheckColumn";
    private static final String FAMILY = "org.mapfaces.treebuilder.CheckColumn";
