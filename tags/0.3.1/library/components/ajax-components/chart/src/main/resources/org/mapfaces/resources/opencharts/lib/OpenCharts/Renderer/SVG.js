 ...
 */
OpenCharts.Renderer.SVG = OpenCharts.Class(OpenCharts.Renderer.Elements, {
    ...
    /**
     * Constructor: OpenCharts.Renderer.SVG
     * 
     * Parameters:
     * containerID - {String}
     */
    initialize: function(containerID) {
        ...
        OpenCharts.Renderer.Elements.prototype.initialize.apply(this, 
                                                                arguments);
     ...
     */
    destroy: function() {
        OpenCharts.Renderer.Elements.prototype.destroy.apply(this, arguments);
    },
    ...
    setExtent: function(extent, resolutionChanged) {
        OpenCharts.Renderer.Elements.prototype.setExtent.apply(this, 
                                                               arguments);
     ...
     * 
     * Parameters:
     * size - {<OpenCharts.Size>} The size of the drawing surface
     */
    setSize: function(size) {
        OpenCharts.Renderer.prototype.setSize.apply(this, arguments);
    ...
    setStyle: function(node, style, options) {
        ...
        var widthFactor = 1;
        var pos;
        if (node._geometryClass == "OpenCharts.Geometry.Point" && r) {
            if (style.externalGraphic) {
            ...
            if (typeof style.rotation != "undefined" && pos) {
                var rotation = OpenCharts.String.format(
...
alert('ici');
     ...
     * 
     * Parameters:
     * components - {Array(<OpenCharts.Geometry.Point>)} Array of points
     ...
     * 
     * Parameters:
     * badComponent - {<OpenCharts.Geometry.Point>)} original geometry of the
     *     invalid point
     * goodComponent - {<OpenCharts.Geometry.Point>)} original geometry of the
     *     valid point
     * Returns
     ...
     * 
     * Parameters:
     * point - {<OpenCharts.Geometry.Point>}
     * 
     * Returns:
    ...
    importSymbol: function (graphicName)  {
        ...
        var symbolExtent = new OpenCharts.Bounds(
    ...
    CLASS_NAME: "OpenCharts.Renderer.SVG"
});
