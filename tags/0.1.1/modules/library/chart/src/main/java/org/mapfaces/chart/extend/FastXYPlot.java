...
public class FastXYPlot extends XYPlot {
   ...
   public final HashSet<Integer> renderedPixels = new HashSet<Integer>();
    ...
    */
   public boolean hasRendered(XYDataset dataset, ValueAxis xAxis, ValueAxis yAxis, RectangleEdge domainEdge,
