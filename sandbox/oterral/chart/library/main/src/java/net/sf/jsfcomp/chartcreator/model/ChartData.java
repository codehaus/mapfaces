 ...
 */
public class ChartData extends JPanel implements Serializable {
    ...
    private PlotOrientation orientation2 = PlotOrientation.VERTICAL;
...
//    private JMenuItem zoomResetRangeMenuItem;
     ...
     * @since 1.0.7
     */
    private boolean zoomAroundAnchor = true;
    /**
...
//            this.chart.addProgressListener(this);
            ...
            if (plot instanceof Zoomable) {
                ...
                this.orientation2 = z.getOrientation();
            }
        } else {
            this.domainZoomable = false;
            this.rangeZoomable = false;
...
//        repaint();
    ...
    public void setRequestParameterMap(HashMap params) {
        this.requestParameterMap = params;
    }
    public HashMap getRequestParameterMap() {
...
//        }
        ...
        boolean hZoom = false;
        boolean vZoom = false;
        if (this.orientation2 == PlotOrientation.HORIZONTAL) {
...
//    }
    ...
    public void zoomInBoth(double x, double y) {        
        this.zoomFactor = this.zoomInFactor;
        Plot plot = this.chart.getPlot();        
...
//        zoomInDomain(selectOrigin.getX(), selectOrigin.getY());
//        zoomInRange(selectOrigin.getX(), selectOrigin.getY());
        zoomInDomain(x, y);
        zoomInRange(x, y);
...
//            plot.setNotify(false);
            Zoomable z = (Zoomable) plot;
            z.zoomDomainAxes(this.zoomFactor, this.info.getPlotInfo(),
...
//            plot.setNotify(savedNotify);
    ...
    public void zoomOutBoth(double x, double y) {     
        this.zoomFactor = this.zoomOutFactor;
        Plot plot = this.chart.getPlot();
        if (plot == null) {
            return;
        }
