...
js: Couldn't open file "C:\svn\mapfaces\trunk\modules\library\main\src\main\resources\org\mapfaces\resources\openlayers/custom/OpenLayers/OpenLayers.js".
OpenLayers.Util={};
...
OpenLayers.Control.OverviewMap=OpenLayers.Class(OpenLayers.Control,{element:null,ovmap:null,size:new OpenLayers.Size(180,90),layers:null,minRectSize:15,minRectDisplayClass:"RectReplacement",minRatio:8,maxRatio:32,mapOptions:null,handlers:null,initialize:function(_1){
this.layers=[];
this.handlers={};
...
var _2=this.map.baseLayer.clone();
this.layers=[_2];
}else{
...
var _3=OpenLayers.Util.getImagesLocation();
var _4=_3+"layer-switcher-maximize.png";
this.maximizeDiv=OpenLayers.Util.createAlphaImageDiv(this.displayClass+"MaximizeButton",null,new OpenLayers.Size(18,18),_4,"absolute");
...
var _4=_3+"layer-switcher-minimize.png";
this.minimizeDiv=OpenLayers.Util.createAlphaImageDiv("OpenLayers_Control_minimizeDiv",null,new OpenLayers.Size(18,18),_4,"absolute");
...
var _5=["dblclick","mousedown"];
for(var i=0;i<_5.length;i++){
OpenLayers.Event.observe(this.maximizeDiv,_5[i],OpenLayers.Event.stop);
OpenLayers.Event.observe(this.minimizeDiv,_5[i],OpenLayers.Event.stop);
}
...
var _8=this.handlers.drag.last.x-px.x;
var _9=this.handlers.drag.last.y-px.y;
if(_8!=0||_9!=0){
var _a=this.rectPxBounds.top;
var _b=this.rectPxBounds.left;
var _c=Math.abs(this.rectPxBounds.getHeight());
var _d=this.rectPxBounds.getWidth();
var _e=Math.max(0,(_a-_9));
_e=Math.min(_e,this.ovmap.size.h-this.hComp-_c);
var _f=Math.max(0,(_b-_8));
_f=Math.min(_f,this.ovmap.size.w-this.wComp-_d);
this.setRectPxBounds(new OpenLayers.Bounds(_f,_e+_c,_f+_d,_e));
}
},mapDivClick:function(evt){
var _11=this.rectPxBounds.getCenterPixel();
var _12=evt.xy.x-_11.x;
var _13=evt.xy.y-_11.y;
var top=this.rectPxBounds.top;
var _15=this.rectPxBounds.left;
var _16=Math.abs(this.rectPxBounds.getHeight());
var _17=this.rectPxBounds.getWidth();
var _18=Math.max(0,(top+_13));
_18=Math.min(_18,this.ovmap.size.h-_16);
var _19=Math.max(0,(_15+_12));
_19=Math.min(_19,this.ovmap.size.w-_17);
this.setRectPxBounds(new OpenLayers.Bounds(_19,_18+_16,_19+_17,_18));
...
},showToggle:function(_1c){
this.maximizeDiv.style.display=_1c?"":"none";
this.minimizeDiv.style.display=_1c?"none":"";
},update:function(){
if(this.ovmap==null){
this.createMap();
}
...
var _1d=this.map.getExtent();
var _1e=this.map.maxExtent;
var _1f=new OpenLayers.Bounds(Math.max(_1d.left,_1e.left),Math.max(_1d.bottom,_1e.bottom),Math.min(_1d.right,_1e.right),Math.min(_1d.top,_1e.top));
var _20=this.ovmap.getResolution()/this.map.getResolution();
return ((_20>this.minRatio)&&(_20<=this.maxRatio)&&(this.ovmap.getExtent().containsBounds(_1f)));
},updateOverview:function(){
var _21=this.map.getResolution();
var _22=this.ovmap.getResolution();
var _23=_22/_21;
if(_23>this.maxRatio){
_22=this.minRatio*_21;
}else{
if(_23<=this.minRatio){
_22=this.maxRatio*_21;
}
}
this.ovmap.setCenter(this.map.center,this.ovmap.getZoomForResolution(_22));
this.updateRectToMap();
},createMap:function(){
var _24=OpenLayers.Util.extend({controls:[],maxResolution:"auto",fallThrough:false},this.mapOptions);
this.ovmap=new OpenLayers.Map(this.mapDiv,_24);
...
var _27=this.getRectBoundsFromMapBounds(this.map.getExtent());
if(_27){
this.setRectPxBounds(_27);
}
},updateMapToRect:function(){
var _28=this.getMapBoundsFromRectBounds(this.rectPxBounds);
this.map.panTo(_28.getCenterLonLat());
},setRectPxBounds:function(_29){
var top=Math.max(_29.top,0);
var _2b=Math.max(_29.left,0);
var _2c=Math.min(_29.top+Math.abs(_29.getHeight()),this.ovmap.size.h-this.hComp);
var _2d=Math.min(_29.left+_29.getWidth(),this.ovmap.size.w-this.wComp);
var _2e=Math.max(_2d-_2b,0);
var _2f=Math.max(_2c-top,0);
if(_2e<this.minRectSize||_2f<this.minRectSize){
this.extentRectangle.className=this.displayClass+this.minRectDisplayClass;
var _30=_2b+(_2e/2)-(this.minRectSize/2);
var _31=top+(_2f/2)-(this.minRectSize/2);
this.extentRectangle.style.top=Math.round(_31)+"px";
this.extentRectangle.style.left=Math.round(_30)+"px";
this.extentRectangle.style.height=this.minRectSize+"px";
this.extentRectangle.style.width=this.minRectSize+"px";
}else{
this.extentRectangle.className=this.displayClass+"ExtentRectangle";
this.extentRectangle.style.top=Math.round(top)+"px";
this.extentRectangle.style.left=Math.round(_2b)+"px";
this.extentRectangle.style.height=Math.round(_2f)+"px";
this.extentRectangle.style.width=Math.round(_2e)+"px";
}
this.rectPxBounds=new OpenLayers.Bounds(Math.round(_2b),Math.round(_2c),Math.round(_2d),Math.round(top));
},getRectBoundsFromMapBounds:function(_32){
var _33=new OpenLayers.LonLat(_32.left,_32.bottom);
var _34=new OpenLayers.LonLat(_32.right,_32.top);
var _35=this.getOverviewPxFromLonLat(_33);
var _36=this.getOverviewPxFromLonLat(_34);
var _37=null;
if(_35&&_36){
_37=new OpenLayers.Bounds(_35.x,_35.y,_36.x,_36.y);
}
return _37;
},getMapBoundsFromRectBounds:function(_38){
var _39=new OpenLayers.Pixel(_38.left,_38.bottom);
var _3a=new OpenLayers.Pixel(_38.right,_38.top);
var _3b=this.getLonLatFromOverviewPx(_39);
var _3c=this.getLonLatFromOverviewPx(_3a);
return new OpenLayers.Bounds(_3b.lon,_3b.lat,_3c.lon,_3c.lat);
},getLonLatFromOverviewPx:function(_3d){
var _3e=this.ovmap.size;
var res=this.ovmap.getResolution();
var _40=this.ovmap.getExtent().getCenterLonLat();
var _41=_3d.x-(_3e.w/2);
var _42=_3d.y-(_3e.h/2);
return new OpenLayers.LonLat(_40.lon+_41*res,_40.lat-_42*res);
},getOverviewPxFromLonLat:function(_43){
var res=this.ovmap.getResolution();
var _45=this.ovmap.getExtent();
var px=null;
if(_45){
px=new OpenLayers.Pixel(Math.round(1/res*(_43.lon-_45.left)),Math.round(1/res*(_45.top-_43.lat)));
}
return px;
...
_4=new OpenLayers.Pixel(px.x+sz.w,px.y);
}
this._addButton("panup","north-mini.png",_4,sz);
px.y=_4.y+sz.h;
this._addButton("panleft","west-mini.png",px,sz);
if(this.zoomWorldIcon){
...
this._addButton("panright","east-mini.png",px.add(_5,0),sz);
this._addButton("pandown","south-mini.png",_4.add(0,sz.h*2),sz);
this._addButton("zoomin","zoom-plus-mini.png",_4.add(0,sz.h*3+5),sz);
_4=this._addZoomBar(_4.add(0,sz.h*4+5));
this._addButton("zoomout","zoom-minus-mini.png",_4,sz);
return this.div;
},_addZoomBar:function(_6){
var _7=OpenLayers.Util.getImagesLocation();
var id="OpenLayers_Control_PanZoomBar_Slider"+this.map.id;
var _9=this.map.getNumZoomLevels()-1-this.map.getZoom();
var _a=OpenLayers.Util.createAlphaImageDiv(id,_6.add(-1,_9*this.zoomStopHeight),new OpenLayers.Size(20,9),_7+"slider.png","absolute");
this.slider=_a;
this.sliderEvents=new OpenLayers.Events(this,_a,null,true);
...
_c=OpenLayers.Util.createAlphaImageDiv(id,_6,new OpenLayers.Size(sz.w,this.zoomStopHeight),_7+"zoombar.png","absolute",null,"crop");
_c.style.height=sz.h+"px";
}else{
_c=OpenLayers.Util.createDiv("OpenLayers_Control_PanZoomBar_Zoombar"+this.map.id,_6,sz,_7+"zoombar.png");
}
this.zoombarDiv=_c;
this.divEvents=new OpenLayers.Events(this,_c,null,true);
...
this.div.appendChild(_c);
this.startTop=parseInt(_c.style.top);
this.div.appendChild(_a);
this.map.events.register("zoomend",this,this.moveZoomBar);
_6=_6.add(0,this.zoomStopHeight*this.map.getNumZoomLevels());
return _6;
},passEventToSlider:function(_d){
this.sliderEvents.handleBrowserEvent(_d);
...
var _11=(y-top)/this.zoomStopHeight;
if(!this.map.fractionalZoom){
_11=Math.floor(_11);
}
var _12=(this.map.getNumZoomLevels()-1)-_11;
_12=Math.min(Math.max(_12,0),this.map.getNumZoomLevels()-1);
this.map.zoomTo(_12);
...
if(this.mouseDragStart!=null){
var _15=this.mouseDragStart.y-evt.xy.y;
var _16=OpenLayers.Util.pagePosition(this.zoombarDiv);
if((evt.clientY-_16[1])>0&&(evt.clientY-_16[1])<parseInt(this.zoombarDiv.style.height)-2){
var _17=parseInt(this.slider.style.top)-_15;
this.slider.style.top=_17+"px";
}
this.mouseDragStart=evt.xy.clone();
OpenLayers.Event.stop(evt);
}
...
var _19=this.zoomStart.y-evt.xy.y;
var _1a=this.map.zoom;
if(this.map.fractionalZoom){
_1a+=_19/this.zoomStopHeight;
_1a=Math.min(Math.max(_1a,0),this.map.getNumZoomLevels()-1);
}else{
_1a+=Math.round(_19/this.zoomStopHeight);
}
this.map.zoomTo(_1a);
this.moveZoomBar();
this.mouseDragStart=null;
...
var _1b=((this.map.getNumZoomLevels()-1)-this.map.getZoom())*this.zoomStopHeight+this.startTop+1;
this.slider.style.top=_1b+"px";
...
OpenLayers.Control.LayerSwitcher=OpenLayers.Class(OpenLayers.Control,{activeColor:"darkblue",layerStates:null,layersDiv:null,baseLayersDiv:null,baseLayers:null,dataLbl:null,dataLayersDiv:null,dataLayers:null,minimizeDiv:null,maximizeDiv:null,ascending:true,initialize:function(_1){
OpenLayers.Control.prototype.initialize.apply(this,arguments);
this.layerStates=[];
},destroy:function(){
...
this.redraw();
return this.div;
},clearLayersArray:function(_3){
var _4=this[_3+"Layers"];
if(_4){
for(var i=0;i<_4.length;i++){
var _6=_4[i];
OpenLayers.Event.stopObservingElement(_6.inputElem);
OpenLayers.Event.stopObservingElement(_6.labelSpan);
}
}
this[_3+"LayersDiv"].innerHTML="";
this[_3+"Layers"]=[];
...
var _9=this.layerStates[i];
var _a=this.map.layers[i];
if((_9.name!=_a.name)||(_9.inRange!=_a.inRange)||(_9.id!=_a.id)||(_9.visibility!=_a.visibility)){
_7=true;
break;
}
}
...
this.layerStates[i]={"name":_e.name,"visibility":_e.visibility,"inRange":_e.inRange,"id":_e.id};
}
var _f=this.map.layers.slice();
if(!this.ascending){
_f.reverse();
}
for(var i=0;i<_f.length;i++){
var _e=_f[i];
var _10=_e.isBaseLayer;
if(_e.displayInLayerSwitcher){
if(_10){
_c=true;
}else{
_b=true;
}
var _11=(_10)?(_e==this.map.baseLayer):_e.getVisibility();
var _12=document.createElement("input");
_12.id="input_"+_e.name;
_12.name=(_10)?"baseLayers":_e.name;
_12.type=(_10)?"radio":"checkbox";
_12.value=_e.name;
_12.checked=_11;
_12.defaultChecked=_11;
if(!_10&&!_e.inRange){
_12.disabled=true;
}
var _13={"inputElem":_12,"layer":_e,"layerSwitcher":this};
OpenLayers.Event.observe(_12,"mouseup",OpenLayers.Function.bindAsEventListener(this.onInputClick,_13));
var _14=document.createElement("span");
if(!_10&&!_e.inRange){
_14.style.color="gray";
}
_14.innerHTML=_e.name;
_14.style.verticalAlign=(_10)?"bottom":"baseline";
OpenLayers.Event.observe(_14,"click",OpenLayers.Function.bindAsEventListener(this.onInputClick,_13));
var br=document.createElement("br");
var _16=(_10)?this.baseLayers:this.dataLayers;
_16.push({"layer":_e,"inputElem":_12,"labelSpan":_14});
var _17=(_10)?this.baseLayersDiv:this.dataLayersDiv;
_17.appendChild(_12);
_17.appendChild(_14);
_17.appendChild(br);
}
}
this.dataLbl.style.display=(_b)?"":"none";
this.baseLbl.style.display=(_c)?"":"none";
return this.div;
...
var _1b=this.baseLayers[i];
if(_1b.inputElem.checked){
this.map.setBaseLayer(_1b.layer,false);
}
}
for(var i=0;i<this.dataLayers.length;i++){
var _1b=this.dataLayers[i];
_1b.layer.setVisibility(_1b.inputElem.checked);
}
},maximizeControl:function(e){
...
},showControls:function(_1e){
this.maximizeDiv.style.display=_1e?"":"none";
this.minimizeDiv.style.display=_1e?"none":"";
this.layersDiv.style.display=_1e?"none":"";
...
var _1f=OpenLayers.Util.getImagesLocation();
var sz=new OpenLayers.Size(18,18);
var img=_1f+"layer-switcher-maximize.png";
...
OpenLayers.Event.observe(this.maximizeDiv,"click",OpenLayers.Function.bindAsEventListener(this.maximizeControl,this));
this.div.appendChild(this.maximizeDiv);
var img=_1f+"layer-switcher-minimize.png";
var sz=new OpenLayers.Size(18,18);
...
},handlerOptions:null,initialize:function(_1,_2,_3){
OpenLayers.Control.prototype.initialize.apply(this,[_3]);
this.callbacks=OpenLayers.Util.extend({done:this.drawFeature},this.callbacks);
this.layer=_1;
this.handler=new _2(this,this.callbacks,this.handlerOptions);
},drawFeature:function(_4){
var _5=new OpenLayers.Feature.Vector(_4);
this.layer.addFeatures([_5]);
this.featureAdded(_5);
},CLASS_NAME:"OpenLayers.Control.DrawFeature"});

OpenLayers.Control.DragFeature=OpenLayers.Class(OpenLayers.Control,{geometryTypes:null,onStart:function(_1,_2){
},onDrag:function(_3,_4){
},onComplete:function(_5,_6){
},layer:null,feature:null,dragCallbacks:{},featureCallbacks:{},lastPixel:null,initialize:function(_7,_8){
OpenLayers.Control.prototype.initialize.apply(this,[_8]);
this.layer=_7;
...
if(this.feature.id==_9.id){
this.over=true;
}else{
this.over=false;
}
}
},downFeature:function(_a){
this.lastPixel=_a;
this.onStart(this.feature,_a);
},moveFeature:function(_b){
var _c=this.map.getResolution();
this.feature.geometry.move(_c*(_b.x-this.lastPixel.x),_c*(this.lastPixel.y-_b.y));
this.layer.drawFeature(this.feature);
this.lastPixel=_b;
this.onDrag(this.feature,_b);
},upFeature:function(_d){
if(!this.over){
this.handlers.drag.deactivate();
this.feature=null;
this.map.div.style.cursor="default";
}
},doneDragging:function(_e){
this.onComplete(this.feature,_e);
},outFeature:function(_f){
if(!this.handlers.drag.dragging){
this.over=false;
this.handlers.drag.deactivate();
this.map.div.style.cursor="default";
...
var _3=this;
var _4={geometryTypes:this.geometryTypes,clickout:this.clickout,toggle:this.toggle};
this.selectControl=new OpenLayers.Control.SelectFeature(_1,_4);
this.layer.events.on({"featureselected":this.selectFeature,"featureunselected":this.unselectFeature,scope:this});
var _5={geometryTypes:["OpenLayers.Geometry.Point"],snappingOptions:this.snappingOptions,onStart:function(_6,_7){
_3.dragStart.apply(_3,[_6,_7]);
},onDrag:function(_8){
_3.dragVertex.apply(_3,[_8]);
},onComplete:function(_9){
_3.dragComplete.apply(_3,[_9]);
}};
this.dragControl=new OpenLayers.Control.DragFeature(_1,_5);
var _a={keypress:this.handleKeypress};
this.handlers={keyboard:new OpenLayers.Handler.Keyboard(this,_a)};
},destroy:function(){
...
this.feature=null;
this.dragControl.deactivate();
this.onModificationEnd(_d.feature);
this.layer.events.triggerEvent("afterfeaturemodified",{feature:_d.feature});
},dragStart:function(_e,_f){
if(_e!=this.feature&&!_e.geometry.parent&&_e!=this.dragHandle&&_e!=this.radiusHandle){
if(this.feature){
this.selectControl.clickFeature.apply(this.selectControl,[this.feature]);
}
if(this.geometryTypes==null||OpenLayers.Util.indexOf(this.geometryTypes,_e.geometry.CLASS_NAME)!=-1){
this.selectControl.clickFeature.apply(this.selectControl,[_e]);
this.dragControl.overFeature.apply(this.dragControl,[_e]);
this.dragControl.lastPixel=_f;
this.dragControl.handlers.drag.started=true;
this.dragControl.handlers.drag.start=_f;
this.dragControl.handlers.drag.last=_f;
}
}
},dragVertex:function(_10){
...
if(_10._index){
_10.geometry.parent.addComponent(_10.geometry,_10._index);
delete _10._index;
OpenLayers.Util.removeItem(this.virtualVertices,_10);
this.vertices.push(_10);
}else{
if(_10==this.dragHandle){
this.layer.removeFeatures(this.vertices);
this.vertices=[];
if(this.radiusHandle){
this.layer.destroyFeatures([this.radiusHandle]);
...
this.layer.drawFeature(_10);
},dragComplete:function(_11){
this.resetVertices();
...
},handleKeypress:function(_12){
if(this.feature&&OpenLayers.Util.indexOf(this.deleteCodes,_12)!=-1){
var _13=this.dragControl.feature;
if(_13&&OpenLayers.Util.indexOf(this.vertices,_13)!=-1&&!this.dragControl.handlers.drag.dragging&&_13.geometry.parent){
_13.geometry.parent.removeComponent(_13.geometry);
this.layer.drawFeature(this.feature,this.selectControl.renderIntent);
this.resetVertices();
this.onModification(this.feature);
this.layer.events.triggerEvent("featuremodified",{feature:this.feature});
...
this.virtualVertices=[];
var _14=this;
function collectComponentVertices(_15){
var i,vertex,component;
if(_15.CLASS_NAME=="OpenLayers.Geometry.Point"){
vertex=new OpenLayers.Feature.Vector(_15);
_14.vertices.push(vertex);
}else{
var _17=_15.components.length;
if(_15.CLASS_NAME=="OpenLayers.Geometry.LinearRing"){
_17-=1;
}
for(i=0;i<_17;++i){
component=_15.components[i];
...
if(_15.CLASS_NAME!="OpenLayers.Geometry.MultiPoint"){
for(i=0;i<_15.components.length-1;++i){
var _18=_15.components[i];
var _19=_15.components[i+1];
if(_18.CLASS_NAME=="OpenLayers.Geometry.Point"&&_19.CLASS_NAME=="OpenLayers.Geometry.Point"){
var x=(_18.x+_19.x)/2;
var y=(_18.y+_19.y)/2;
var _1c=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(x,y),null,_14.virtualStyle);
_1c.geometry.parent=_15;
_1c._index=i+1;
_14.virtualVertices.push(_1c);
}
}
}
}
...
var _1d=this.feature.geometry;
var _1e=_1d.getBounds().getCenterLonLat();
var _1f=new OpenLayers.Geometry.Point(_1e.lon,_1e.lat);
var _20=new OpenLayers.Feature.Vector(_1f);
_1f.move=function(x,y){
...
var _23=this.feature.geometry;
var _24=_23.getBounds();
var _25=_24.getCenterLonLat();
var _26=new OpenLayers.Geometry.Point(_25.lon,_25.lat);
var _27=new OpenLayers.Geometry.Point(_24.right,_24.bottom);
var _28=new OpenLayers.Feature.Vector(_27);
var _29=(this.mode&OpenLayers.Control.ModifyFeature.RESIZE);
var _2a=(this.mode&OpenLayers.Control.ModifyFeature.ROTATE);
_27.move=function(x,y){
OpenLayers.Geometry.Point.prototype.move.call(this,x,y);
var dx1=this.x-_26.x;
var dy1=this.y-_26.y;
var dx0=dx1-x;
var dy0=dy1-y;
if(_2a){
...
_23.resize(l1/l0,_26);
}
};
this.radiusHandle=_28;
