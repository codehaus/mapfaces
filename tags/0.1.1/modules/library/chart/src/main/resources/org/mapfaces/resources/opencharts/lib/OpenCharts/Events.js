    ...
    */
    ...
    getMousePosition: function (evt) {
        ...
        if (!this.element.scrolls) {
            ...
            this.element.scrolls[0] = 0 ; //(document.documentElement.scrollLeft || document.body.scrollLeft);
            this.element.scrolls[1] = 0 ; //(document.documentElement.scrollTop|| document.body.scrollTop);
        }
