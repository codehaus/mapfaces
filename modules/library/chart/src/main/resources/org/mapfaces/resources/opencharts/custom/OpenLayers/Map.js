...
OpenLayers.Map = OpenLayers.Class({
     ...
     * animated panning.
     */
    panMethod: null, //OpenLayers.Easing.Expo.easeOut,
    ...
    initialize: function (div, options) {
        ...
        if (this.isHTML) {
            ...
            this.size = new OpenLayers.Size(this.div.getAttribute("width"),this.div.getAttribute("height"));
        }
    ...
    pan: function(dx, dy, options) {
        if(this.isHTMl) {
            ...
            draggingElement = this.div;
            var p = document.documentElement.createSVGPoint();
            p.x = 0;
            p.y = 0;
            //            
            p = p.matrixTransform(OpenLayers.Util.getScreenCTM().inverse());
            p.x -= (dx - parseFloat(this.div.getAttribute("x")));
            p.y -= (dy - parseFloat(this.div.getAttribute("y")));
